...
open class BaseRecyclerAdapter<T>(private val resourceItem :Int) : RecyclerView.Adapter<BaseRecyclerAdapter<T>.ViewHolder>() {
...
open class BaseRecyclerOnClickAdapter<T>(resourceItem :Int, private val onItemClick : (T)-> Unit ={}) : BaseRecyclerAdapter<T>(resourceItem){
